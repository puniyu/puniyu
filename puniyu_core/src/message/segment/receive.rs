...
impl Segment {
	pub fn at(target_id: String, name: Option<String>) -> ReceiveAtElement {
		ReceiveAtElement { r#type: "at".to_string(), target_id, name }
	}
	...
	pub fn face(id: u64) -> ReceiveFaceElement {
		ReceiveFaceElement { r#type: "face".to_string(), id }
	}
	...
	pub fn file(
		...
		ReceiveFileElement { r#type: "file".to_string(), file_size, file_name, file, file_id }
	}
	...
	pub fn image(file: String, is_flash: bool, summary: Option<String>) -> ReceiveImageElement {
		ReceiveImageElement { r#type: "image".to_string(), file, is_flash, summary }
	}
	...
	pub fn json(data: String) -> JsonElement {
		JsonElement { r#type: "json".to_string(), data }
	}
	...
	pub fn music(music_id: String) -> MusicElement {
		let data = MusicData::Standard { platform: String::new(), id: music_id };
		MusicElement { r#type: "music".to_string(), data }.qq()
	}
	...
	pub fn record(file: String) -> RecordElement {
		RecordElement { r#type: "record".to_string(), file }
	}
	...
	pub fn reply(message_id: String) -> ReplyElement {
		ReplyElement { r#type: "reply".to_string(), message_id }
	}
	...
	pub fn text(text: String) -> TextElement {
		TextElement { r#type: "text".to_string(), text }
	}
	...
	pub fn video(file: String) -> VideoElement {
		VideoElement { r#type: "video".to_string(), file }
	}
	...
	pub fn xml(data: String) -> XmlElement {
		XmlElement { r#type: "xml".to_string(), data }
	}
}
