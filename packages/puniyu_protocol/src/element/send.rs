pub(crate) use puniyu_types::element::send as puniyu_element;
...
impl_from_element!(ImageElement, puniyu_element::ImageElement { file, summary });
impl_from_element!(FileElement, puniyu_element::FileElement { file, file_name });
