...
impl_element_from!(bmap,TextElement, puniyu_element::TextElement<'a>, value, {
	text: value.text.as_str()
});
impl_element_from!(bmap,AtElement, puniyu_element::AtElement<'a>, value, {
	target_id: value.target_id.as_str()
});
impl_element_from!(bmap,ReplyElement, puniyu_element::ReplyElement<'a>, value, {
	message_id: value.message_id.as_str()
});
impl_element_from!(bmap,FaceElement, puniyu_element::FaceElement, value, {
	id: value.id
});
impl_element_from!(bmap,ImageElement, puniyu_element::ImageElement<'a>, value, {
...
impl_element_from!(bmap,FileElement, puniyu_element::FileElement<'a>, value, {
	file: value.file.clone(),
	file_size: value.file_size,
	file_name: value.file_name.as_str()
});
impl_element_from!(bmap,VideoElement, puniyu_element::VideoElement<'a>, value, {
	file: value.file.clone(),
	file_name: value.file_name.as_str()
});
impl_element_from!(bmap,RecordElement, puniyu_element::RecordElement<'a>, value, {
	file: value.file.clone(),
	file_name: value.file_name.as_str()
});
impl_element_from!(bmap,JsonElement, puniyu_element::JsonElement<'a>, value, {
	data: value.data.as_str()
});
impl_element_from!(bmap,XmlElement, puniyu_element::XmlElement<'a>, value, {
	data: value.data.as_str()
});
...
impl_element_from!(
	boneof, Element, puniyu_element::Elements<'a>, value, {
...
impl_vec_element_from!(ref, Elements, puniyu_element::Elements<'a>);
