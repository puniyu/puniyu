...
* The following workspace dependencies were updated
  * dependencies
    ...
    * puniyu_matcher bumped from 0.3.0 to 0.4.0
    * puniyu_handler bumped from 0.3.0 to 0.4.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * puniyu_matcher bumped from 0.2.0 to 0.3.0
    * puniyu_handler bumped from 0.2.0 to 0.3.0
    * puniyu_event bumped from 0.2.0 to 0.3.0

## [0.2.0](https://github.com/puniyu/puniyu/compare/event-bus-v0.1.8...event-bus-v0.2.0) (2025-11-15)
