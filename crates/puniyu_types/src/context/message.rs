use crate::adapter::{SendMsgType};
use crate::command::ArgValue;
use crate::contact::ContactType;
use crate::context::bot::BotContext;
use crate::element::receive::Elements;
use crate::element::Message;
use crate::event::message::{FriendMessage, GroupMessage, MessageEvent, MessageSubType};
...
impl<'c> MessageContext<'c> {
	...
	pub async fn reply(&self, message: impl Into<Message<'c>>) -> HandlerResult<SendMsgType> {
