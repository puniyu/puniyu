...
use crate::event::notion::{
    NotionBase, NotionBuilder, NotionSubEvent, PrivateRecallOption,
};
...
impl EventBase<EventType, NotionSubEvent> for PrivateRecall<'_> {
