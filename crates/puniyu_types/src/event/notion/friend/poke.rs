...
use crate::event::notion::{NotionBase, NotionBuilder, NotionSubEvent, PrivatePokeOption};
...
impl EventBase<EventType, NotionSubEvent> for PrivatePoke<'_> {
